...
bool checkLogicGate4Bits(int pinA, int pinB, int pinC, int pinD, int pinSalida, bool (*logicGateFunction)(int, int, int, int, int, int, int, int, int, const char*)) {
  ...
  for (int i = 0; i < 16; i++) {
    ...
    resultado &= logicGateFunction(statesA4bits[i], statesB4bits[i], statesC4bits[i], statesD4bits[i]);
...
bool checkLogicGate3Bits(int pinA, int pinB, int pinC, int pinSalida, bool (*logicOperation)(int, int, int, int, int, int, int, const char*)) {
